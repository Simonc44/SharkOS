...
# Alias canoniques (convention shark-*) — les noms sans tiret ci-dessus
# restent disponibles pour compatibilité.
alias shark-scan='sudo nmap -sV -O --open'
alias shark-sniff='sudo tcpdump -i any -n'
...
alias sharkgame='shark-game'   # Game launcher via GameMode + MangoHud (hook 30)
alias shark-turbo='sudo /usr/local/bin/shark-turbo'   # Mode performance HyperOS (hook 60)
alias shark-extras='sudo /usr/local/bin/shark-extras' # Install optionnel office/mail/gaming (hook 50)
alias shark-anim='sudo /usr/local/bin/shark-anim'     # Animations HyperOS : Compiz on/off (hook 60)
